...
int main() {
    ...
    char cod_carta1[3], cod_carta2[3];//Variáveis string composta pelo estado e 2 números(ex. A01)
    ...
    printf("Digite o código da Carta 1: ");//solicita que se digite o código da carta composto pela letra do Estado e sequencia de 2 números
    scanf("%s", cod_carta1);//Guarda o código digitado na variável

    printf("Digite a população da cidade: ");//solicita que se digite a quantidade de habitantes da cidade
    scanf("%i", &populacao1);//Guarda o valoor da populção

    printf("Digite a área da cidade: ");//solicta que se digite a área em quilometros quandrados da cidade
    ...
    printf("PIB: %.2f bilhões de reais\n", PIB1);\\exibe valor digitado concatenando com complemento
    printf("Pontos Turísticos: %i\n\n", num_ponto_turistico1);\\exibe a quantidade de ponstos turíscos da cidade
